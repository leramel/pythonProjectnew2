...
@app.route('/')
def index():
    return "Миссия Колонизация Марса, <a href=http://127.0.0.1:8080/index>index</a><title>Привет, Марс!</title>"

@app.route('/index')
def index2():
    return 'И на Марсе будут яблони цвести!, <a href=http://127.0.0.1:8080/promotion>promotion</a><title>Привет, Марс!</title>'
...
def promotion():
    ...
    return f'''{'</br>'.join(data)}, <a href=http://127.0.0.1:8080/image_mars>image_mars</a><title>Привет, Марс!</title>'''
